...
void loop() {
  ...
  Joystick.button(9, not digitalRead(13));
  Joystick.button(10, not digitalRead(14));
  Joystick.button(11, not digitalRead(15));
  Joystick.button(12, not digitalRead(16));
  Joystick.button(13, not digitalRead(17));
  Joystick.button(14, not digitalRead(18));
